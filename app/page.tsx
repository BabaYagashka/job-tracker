        ...
        <section className="container mx-auto px-4 py-32 ">
          <div className="mx-auto max-w-4xl text-center">
            <h1 className="text-black mb-6 text-6xl font-bold">
              A Better <span className="text-primary">Way</span> To Track Your
              Job Applications.
            </h1>
            <p className="text-muted-foreground mb-10 text-xl">
              Capture, organize and track your job applications with ease. Our
              platform provides a seamless experience to help you stay on top of
            ...
            <div className="flex flex-col items-center gap-4">
              <Link href="/sign-up">
                <Button
                  variant={"default"}
                  size={"lg"}
                  className="h-12 px-8 text-lg hover:cursor-pointer"
                >
            ...
            <div className="grid gap-12 md:grid-cols-3">
              <div className="flex flex-col items-center">
                <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-primary/10">
                  <Briefcase className="h-6 w-6 text-primary justify-center" />
                </div>
